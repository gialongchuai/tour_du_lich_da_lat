...
{
    public class TourWishlistModel
    {
        public int WishlistId { get; set; } // Mã wishlist
        public string WishlistName { get; set; } // Tên wishlist
        ...
        public List<string> additional_imgs { get; set; }
    }
